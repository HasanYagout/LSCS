                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="bd-one bd-c-black-10 bd-ra-25 bg-white py-28 px-25">
                                <div class="d-flex align-items-center flex-wrap flex-sm-nowrap rg-10 cg-11 pb-17">
                                    <div class="flex-shrink-0 w-51 h-51 bd-one bd-c-stroke-color rounded-circle d-flex justify-content-center align-items-center">
                                        <img onerror="this.src='{{ asset('public/assets/images/no-image.jpg') }}'" src="{{ asset('public/storage/company/image').'/'.$job->company_logo }}" alt="" class="rounded-circle w-100 h-100">
                                    </div>
                                    <div class="">
                                        ...
                                        <div class="d-flex align-items-center cg-7">
                                            <div class="d-flex">
                                                <img src="{{ asset('public/frontend/images/icon/calendar-1.svg') }}" alt="">
                                            </div>
                                ...
                                <div class="pb-23">
                                    <div class="fs-18 fw-400 lh-28 text-para-color mb-21 line-clamp-3 sf-text-ellipsis min-h-84">
                                ...
                                <div class="d-flex align-items-center flex-wrap cg-8 rg-21 pb-30">
                                    <div class="d-flex align-items-center cg-7">
                                        <div class="d-flex">
                                            <img src="{{ asset('/frontend/images/icon/bag-suitcase.svg') }}" alt="">
                                        </div>
                                    ...
                                    <div class="d-flex align-items-center cg-7">
                                        <div class="d-flex">
                                            <img src="{{ asset('public/frontend/images/icon/location-1.svg') }}" alt="">
                                        </div>
                                        <p class="fs-18 fw-400 lh-16 text-para-color">{{ $job->location ?? '' }}</p>
                                    </div>
                                    <div class="d-flex align-items-center cg-7">
                                        <div class="d-flex">
                                            <img src="{{ asset('/frontend/images/icon/dollar-coin.svg') }}" alt="">
                                        </div>
                                        <p class="fs-18 fw-400 lh-16 text-para-color">{{ $job->salary ?? '' }}</p>
                                    </div>
                                </div>
                                <a href="{{ route('job.view.details', $job->slug) }}" class="fs-18 fw-500 lh-22 text-black-color text-decoration-underline hover-color-primary">{{ __('More Details') }}</a>
                            </div>
                        </div>
                    @empty
