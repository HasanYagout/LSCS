        ...
        <div id="printableArea" class="bg-white overflow-hidden rounded-5">
            <div class="">
                ...
                <div class="p-20 pb-27 text-center">
                    @if($success == true)
                        <div class="d-flex justify-content-center pb-30"><img class="w-25"
                                                                              src="{{ asset('assets/images/successful-message.png')}}"
                                                                              alt=""/></div>
                        ...
                        <p class="fs-15 fw-400 lh-17 pb-14 max-w-260 m-auto mt-2"><span
                                class="fw-600">{{__('Participant: ')}}</span>{{ $ticket->user->name }}</p>
                        <p class="fs-15 fw-400 lh-17 pb-14 max-w-260 m-auto mt-3">{{ $ticket->event->title }}</p>
                    @else
                        <div class="d-flex justify-content-center pb-30"><img
                                src="{{ asset('assets/images/failed-message.png')}}" alt=""/></div>
