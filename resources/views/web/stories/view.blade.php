    ...
    <section class="pb-110 pt-60">
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4">
                    <!-- Image -->
                    <div class="bd-ra-20 overflow-hidden mb-42"><img src="{{asset('public/storage/admin/story').'/'.$story->thumbnail}}" alt="" class="w-100"/></div>
                    <!-- Text -->
                    <div class="fs-18 fw-400 lh-28 text-para-color pb-25 border border-3 border border-dark p-3 fs-1">
                        {!! ($story->body) !!}
                    </div>
                </div>
            </div>
