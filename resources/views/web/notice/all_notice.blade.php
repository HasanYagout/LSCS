        ...
        <div class="row rg-24">
            @forelse ( $allNotice as $notice )
                <div class="col-lg-4 col-md-6">
                    <div class="bd-ra-25 h-100 bg-event-bg py-32 px-27 border border-5 border border-dark">
                        <p class="fs-18 fw-500 lh-28 text-scroll-track">{{ date('M d, Y', strtotime($notice->created_at)) }}</p>
