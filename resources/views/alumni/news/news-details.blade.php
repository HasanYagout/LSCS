            ...
            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
              ...
              <div class="d-flex align-items-center cg-8 pb-10">
                ...
                <div class="d-flex align-items-center cg-10">
                  <div class="flex-shrink-0 w-30 h-30 bd-one bd-c-1b1c17 rounded-circle overflow-hidden bg-eaeaea d-flex justify-content-center align-items-center"><img onerror="this.src='{{asset('public/assets/images/no-image.jpg')}}'" src="{{asset('public/storage/admin').'/'.$news->author->image}}" alt=""></div>
