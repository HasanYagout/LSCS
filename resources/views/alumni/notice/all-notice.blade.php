            ...
            <div class="row rg-30">
              ...
              @forelse ( $Allnotice as $notice )
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <div class="img">
                        <img onerror="this.src='{{asset('public/assets/images/no-image.jpg')}}'" src="{{asset('public/storage/admin/notice').'/'.$notice->image}}" alt=""></div>
                    <div class="content">
                        ...
                        <a href="{{route('alumni.notice.details', $notice->slug)}}" class="link">{{__('More Details')}}</a>
                    </div>
                    </div>
                </div>
              @empty
