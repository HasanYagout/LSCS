<div
    class="main-header pt-10 pb-10 px-30  bg-002a5c d-flex justify-content-between align-items-center">
    <!-- Left -->
...
{{--                            src="{{ asset(getFileUrl(auth('alumni')->user()->image)) }}" alt="{{ auth('alumni')->user()->name}}" />--}}
{{--                    </div>--}}
