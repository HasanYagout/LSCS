...
{{--@if (auth('alumni')->check() && auth('alumni')->user()->role_id == USER_ROLE_ALUMNI)--}}
{{--    <div class="zSidebar">--}}
{{--        <div class="zSidebar-overlay"></div>--}}
{{--        <!-- Logo -->--}}
{{--        <a href="{{ route('index') }}" class="d-block mx-26 mb-27 max-w-146 pt-23">--}}
...
<div class="zSidebar">
    ...
    <div class="zSidebar-fixed">
        <ul class="zSidebar-menu" id="sidebarMenu">
            ...
            @endif
                <li>
                    <a href="{{ route($authenticatedGuard.'.home') }}" class="{{ $activeHome ?? '' }} d-flex align-items-center cg-10">
                        <div class="d-flex">
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="20" viewBox="0 0 22 20"
                                 fill="none">
                                <path d="M1.71387 11.4286L10.9996 2.14285L20.2853 11.4286" stroke="white"
                ...
                <li>
                    <a href="{{ route($authenticatedGuard.'.profile.index') }}" class="{{ $activeProfile ?? '' }} d-flex align-items-center cg-10">
                        <div class="d-flex">
                            <svg width="24" height="25" viewBox="0 0 24 25" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                                <path
                ...
                @if($authenticatedGuard=='alumni')
                    <li>
                        ...
                        <a href="{{route($authenticatedGuard.'.notices.index')}}" class="{{ $activeManageNotice ?? '' }} d-flex align-items-center cg-10">
                            <div class="d-flex">
                                <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <circle cx="10" cy="10" r="9.25" stroke="white"
                    ...
                    <li>
                        ...
                        <a href="{{route($authenticatedGuard.'.news.index')}}" class="{{ $activeManageNotice ?? '' }} d-flex align-items-center cg-10">
                            <div class="d-flex">
                                <svg width="20" height="18" viewBox="0 0 20 18" fill="none"
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path
