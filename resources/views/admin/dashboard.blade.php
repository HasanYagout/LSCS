...
<rect x="3" y="6" width="18" height="15" rx="2" stroke="#f1a527" stroke-width="1.4"/>
<path d="M4 11H20" stroke="#f1a527" stroke-width="1.4" stroke-linecap="round"/>
<path d="M9 16H15" stroke="#f1a527" stroke-width="1.4" stroke-linecap="round"/>
<path d="M8 3L8 7" stroke="#f1a527" stroke-width="1.4" stroke-linecap="round"/>
<path d="M16 3L16 7" stroke="#f1a527" stroke-width="1.4" stroke-linecap="round"/>
</svg>'],
...
<path d="M17.0712 5.5H2.92829C2.21821 5.5 1.64258 6.07563 1.64258 6.78571V17.0714C1.64258 17.7815 2.21821 18.3571 2.92829 18.3571H17.0712C17.7812 18.3571 18.3569 17.7815 18.3569 17.0714V6.78571C18.3569 6.07563 17.7812 5.5 17.0712 5.5Z" stroke="#f1a527" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
<path d="M13.8569 5.49997V2.92854C13.8569 2.58754 13.7214 2.26052 13.4803 2.0194C13.2392 1.77828 12.9121 1.64282 12.5711 1.64282H7.42829C7.0873 1.64282 6.76027 1.77828 6.51916 2.0194C6.27804 2.26052 6.14258 2.58754 6.14258 2.92854V5.49997" stroke="#f1a527" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
</svg>']
                        ...
                        <div class="h-100 zNews-item-one shadow-sm">
                            <div class="content">
                                ...
                                <div class="d-flex justify-content-between mt-20">
                                    ...
                                    <div class="d-flex text-secondary-color">
                                        {!! $item['icon'] !!}
                                    </div>
                                </div>
                            </div>
