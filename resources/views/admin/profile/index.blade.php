        ...
        <div class="">
            ...
            <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                ...
                <div class="tab-content zTabContent" id="myTabContent">
                    ...
                    <!-- Edit Profile -->
                    <div class="tab-pane fade show {{ session('active_tab') == 'editProfile-tab' ? 'active' : '' }}" id="editProfile-tab-pane" role="tabpanel" aria-labelledby="editProfile-tab" tabindex="0">
                        <div class="max-w-840">
