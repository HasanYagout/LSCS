<form class="ajax reset" action="{{ route('admin.students.update', $student->id) }}" method="post"
            ...
            <div class="col-12">
                <div class="primary-form-group mt-2">
                    <div class="primary-form-group-wrap">
                        ...
                        <input type="text" class="primary-form-control" name="name" value="{{$student->first_name}}">
                    </div>
                </div>
            </div>
        </div>
