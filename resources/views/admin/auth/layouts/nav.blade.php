                    ...
                    <div class="navbar-collapse menu-navbar-collapse offcanvas offcanvas-start" tabindex="-1"
                        ...
                        <ul class="navbar-nav justify-content-around menu-navbar-nav justify-content-center flex-wrap cg-42 rg-10 w-100">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link fs-18 hover-color-secondary fw-500 lh-28 text-white p-0 dropdown-toggle menu-dropdown-toggle"
                                   href="#" role="button" data-bs-toggle="dropdown"
                                   aria-expanded="false">{{ __('Company') }}</a>
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item hover-color-secondary" href="{{ route('company.auth.register') }}">
                                            {{ __('Sign up') }}
                                            <span><i class="fa-solid fa-long-arrow-right"></i></span>
                                        </a>
                                    </li>
                                    <li>
                                        <a class="dropdown-item hover-color-secondary" href="{{ route('company.auth.login') }}">
                                            {{ __('Login') }}
                                            <span><i class="fa-solid fa-long-arrow-right"></i></span>
                                        </a>
