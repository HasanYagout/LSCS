                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary-form-group my-2 pt-3">
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <div class="">
                                                    <textarea name="cookie_policy_title"
                                                              class="primary-form-control">{{ getOption('cookie_policy_title') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <div class="">
                                                    <textarea name="cookie_policy_description"
                                                              class="primary-form-control summernoteOne">{{ getOption('cookie_policy_description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
