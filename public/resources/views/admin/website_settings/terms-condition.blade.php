                                    ...
                                    <div class="col-lg-6">
                                        <div class="primary-form-group my-2 pt-3">
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <div class="">
                                                    <textarea name="terms_condition_title"
                                                              class="primary-form-control">{{ getOption('terms_condition_title') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="primary-form-group-wrap">
                                                ...
                                                <div class="">
                                                    <textarea name="terms_condition_description"
                                                              class="primary-form-control summernoteOne">{{ getOption('terms_condition_description') }}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
