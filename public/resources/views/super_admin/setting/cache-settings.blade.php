                ...
                <div class="col-xxl-10 col-lg-9 col-md-8">
                    ...
                    <div class="bg-white bd-half bd-c-ebedf0 bd-ra-25 p-30">
                        <div class="email-inbox__area bg-style form-horizontal__item bg-style admin-general-settings-page">
                            ...
                            <div class="custom-form-group mb-3 row rg-10 align-items-center">
                                <label for=""
                                    class="col-lg-3 text-lg-right text-black">{{ __('Clear View Cache') }}</label>
                                <div class="col-lg-9">
                                    <a href="{{ route('super_admin.setting.cache-update', 1) }}"
                                        class="d-inline-block fs-15 fw-500 lh-25 text-black py-10 px-26 bg-7f56d9 bd-ra-12">{{ __('Click Here') }}</a>
                                </div>
                            </div>
                            <div class="custom-form-group mb-3 row rg-10 align-items-center">
                                <label for=""
                                    class="col-lg-3 text-lg-right text-black">{{ __('Clear Route Cache') }} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row rg-10 align-items-center">
                                <label for=""
                                    class="col-lg-3 text-lg-right text-black">{{ __('Clear Config Cache') }} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row rg-10 align-items-center">
                                <label for=""
                                    class="col-lg-3 text-lg-right text-black">{{ __('Application Clear Cache') }} </label>
                                <div class="col-lg-9">
                            ...
                            <div class="custom-form-group mb-3 row rg-10 align-items-center">
                                <label for="" class="col-lg-3 text-lg-right text-black">{{ __('Storage Link') }}
                                </label>
                                <div class="col-lg-9">
