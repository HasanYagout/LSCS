                            ...
                            <div
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb mb-0">
                                        <li class="breadcrumb-item"><a href="{{ route('super_admin.dashboard') }}"
                                            ...
                                            <tbody class="align-baseline">
                                                ...
                                                @if ($uploadedFile != '')
                                                    <tr>
                                                        <td>
                                                            {{ $uploadedFile }}
                                                            <a data-url="{{ route('super_admin.addon.delete', $code) }}"
                                                                data-reload="true"
                                                        ...
                                                        <td>
                                                            <a data-url="{{ route('super_admin.addon.execute') }}"
    ...
    <div class="modal fade" id="addonUpdateModal" tabindex="-1" aria-labelledby="addonUpdateModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form class="ajax" action="{{ route('super_admin.addon.execute') }}" method="POST"
...
@push('script')
    ...
    <script>
        ...
        var myDropzone = new Dropzone(document.body, { // Make the whole body a dropzone
            url: "{{ route('super_admin.addon.store') }}", // Set the url
            method: 'post',
            headers: {
