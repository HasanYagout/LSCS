(function ($) {
    ...
    var table = $("#jobPostAlldataTable").DataTable({
        ...
        columns: [
            ...
            { "data": "company", "name": "company.name", responsivePriority: 1, orderable: true, searchable: true },
            ...
            { "data": "posted_by", "name": "posted_by", responsivePriority: 3, orderable: true, searchable: true },
